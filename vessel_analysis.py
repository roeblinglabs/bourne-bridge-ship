...
# Bourne Bridge location (Manually copy-pasted from Google Maps)
BRIDGE_LAT = 41.74780806781494
BRIDGE_LON = -70.58955096082288

# Bourne Bridge piers (Manually copy-pasted from Google Maps)
BOURNE_BRIDGE_PIERS = {
    'north_pier': {
        'name': 'Northeast Pier (Cape Cod side)',
        'lat': 41.74853041744204,
        'lon': -70.59016327842681,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'south_pier': {
        'name': 'Southwest Pier (mainland side)',
        'lat': 41.74701754716035,
        'lon': -70.58916549671078,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    }
}
...
def analyze_vessel(ship_data):
    ...
    pier = BOURNE_BRIDGE_PIERS[closest_pier_id]
